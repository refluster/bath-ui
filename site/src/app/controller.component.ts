...
export class ControllerComponent {
	...
	private voicectrl_data = [
		...
		{json: {lightA: {bright: 1}}, text: 'lightA bright 1s'},
		{json: {lightA: {bright: .1}}, text: 'lightA bright 0.1s'},
		{json: {lightA: {dark: 1}}, text: 'lightA dark 1s'},
		...
		{json: {lightB: {bright: 1}}, text: 'lightB bright 1s'},
		{json: {lightB: {bright: .1}}, text: 'lightB bright 0.1s'},
		{json: {lightB: {dark: 1}}, text: 'lightB dark 1s'},
